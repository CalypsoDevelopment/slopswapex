<template>
  <b-container fluid class="bg px-0">
    ...
    <b-container fluid>
      ...
      <div class="my-2 py-2">
        <b-card no-body>
          <b-tabs class="tab-container" card>
            <b-tab title="Multi-Chain Wallet Generator" active>
              <b-card-text>
                <SlopWalletGenerator />
              </b-card-text>
            </b-tab>
            <b-tab title="Wallet Balances">
...
import SlopWalletGenerator from '~/components/SlopWalletGenerator.vue'

export default {
  name: 'WalletInterfacePage',
  components: { TopNavbarComplex, SlopWalletGenerator }
}
</script>
<style scoped>
...
.tab-container {
  font-variant-caps: all-small-caps;
  font-family: 'Fredoka One', sans-serif;
  background: linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(46,163,230,1) 95%, rgba(255,158,46,1) 100%);
}
</style>
