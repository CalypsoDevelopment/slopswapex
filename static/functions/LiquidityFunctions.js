...
// import { fetchReserves, getDecimals } from '~/static/functions/ethereumFunctions.js'

const ERC20 = require('~/static/artifacts/IERC20.json')
const PAIR = require('~/static/artifacts/ISlopSwapPair.json')
const fetchReserves = require('~/static/functions/ethereumFunctions.js')
const getDecimals = require('~/static/functions/ethereumFunctions.js')
